package com.osirion.conversor;

import com.osirion.app.MensajeFinal;
import javax.swing.ImageIcon;
import javax.swing.JOptionPane;

public class Divisas {
    // Carga los íconos para mostrar en el cuadro de diálogo
    ImageIcon icon = new ImageIcon(getClass().getResource("/com/osirion/icons/icon-divisa.png"));
    ImageIcon iconM = new ImageIcon(getClass().getResource("/com/osirion/icons/icon-error.png"));
