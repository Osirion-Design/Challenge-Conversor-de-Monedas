...
public class MensajeFinal {
    ...
    ImageIcon iconP = new ImageIcon(getClass().getResource("/com/osirion/icons/icon-question.png"));
    ImageIcon iconE = new ImageIcon(getClass().getResource("/com/osirion/icons/icon-salir.png"));
